...
export EXPERIMENT_NAME=skywork-or1-1p5b-32k-0-steps-mixed-gt2-with-kl-log-p-clip-0.2-amplify-2
...
if [ "${HOSTNAME##*-}" -eq 0 ]; then
    ...
    python3 -m verl.trainer.main_ppo \
        ...
        actor_rollout_ref.actor.force_offline_ratio_to_one=True \
        actor_rollout_ref.actor.max_scale_offline=2.0 \
