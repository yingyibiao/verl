...
export BASE_MODEL=/checkpoints-fsx/yibiaoy-sandbox/skywork-or1/skywork-or1-1p5b-baseline-32k/merged_hf_model/global_step_3000
export MLFLOW_TRACKING_URI=file:///data-fsx/yibiaoy-sandbox/skywork-or1/mlflow_logs
export EXPERIMENT_NAME=skywork-or1-1p5b-32k-3000-steps-mixed-gt2-with-kl-lr-4x10-7-warmup-shortest
...
if [ "${HOSTNAME##*-}" -eq 0 ]; then
    ...
    python3 -m verl.trainer.main_ppo \
        ...
        data.offline_sample_method=shortest \
        ...
        trainer.project_name='verl-skywork-or1-mixed-new-eval' \
