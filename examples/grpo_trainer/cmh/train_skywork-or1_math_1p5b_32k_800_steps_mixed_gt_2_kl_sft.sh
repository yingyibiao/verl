...
export BASE_MODEL=/checkpoints-fsx/yibiaoy-sandbox/skywork-or1/skywork-or1-1p5b-baseline/merged_hf_model/global_step_800
export MLFLOW_TRACKING_URI=file:///data-fsx/yibiaoy-sandbox/skywork-or1/mlflow_logs
export EXPERIMENT_NAME=skywork-or1-1p5b-32k-800-steps-mixed-gt2-with-kl-sft
