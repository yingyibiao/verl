...
export EXPERIMENT_NAME=skywork-or1-1p5b-32k-0-steps-mixed-gt1-with-kl
...
train_1p5b_math_file=/data/yibiaoy-sandbox/skywork-or1/train_files/train_1p5b_math_modified_gt_1.parquet
