...
export EXPERIMENT_NAME=skywork-or1-1p5b-baseline-32k-3000-steps-mixed-correct-rollout-with-kl
...
train_1p5b_math_file=/data/yibiaoy-sandbox/skywork-or1/train_1p5b_math_modified_no_index.parquet
...
if [ "${HOSTNAME##*-}" -eq 0 ]; then
    ...
    python3 -m verl.trainer.main_ppo \
        ...
        trainer.resume_from_path='/checkpoints/yibiaoy-sandbox/skywork-or1/skywork-or1-1p5b-baseline-32k/global_step_3000' \
