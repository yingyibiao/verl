...
BASE_DIR="/checkpoints/yibiaoy-sandbox/skywork-or1/skywork-or1-1p5b-32k-0-steps-mixed-gt2-with-kl-log-p-clip-0.2-amplify-2/merged_hf_model"
OUT_DIR="./outputs/evaluation/skywork-or1-1p5b-32k-0-steps-mixed-gt2-with-kl-log-p-clip-0.2-amplify-2"
LOG_DIR="./logs/skywork-or1-1p5b-32k-0-steps-mixed-gt2-with-kl-log-p-clip-0.2-amplify-2"
